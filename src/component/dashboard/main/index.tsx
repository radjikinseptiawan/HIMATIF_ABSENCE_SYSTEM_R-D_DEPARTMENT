    ...
    <div>
      <div className="bg-white p-4 md:p-8 h-auto md:h-xl xl:h-1/2 shadow-2xl rounded w-full md:w-xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-3">
          ...
          <a href="#" className="text-cyan-500 hover:text-red-600 hover:cursor-pointer underline">Rapat Paripurna Pengesahan UU Perampasan Aset</a>
        </div>
        <div className="flex justify-center my-3">
          <button className="bg-cyan-500 px-4 py-2 rounded-2xl font-bold" onClick={() => setOpen(true)}>Absen</button>
        </div>
        <div className="flex justify-center gap-2 mb-2">
          <p className="text-cyan-500">Status :</p>
          <p className={status !== "Sudah Absen" ?  "text-orange-800" : "text-lime-800"}>{status !== "Sudah Absen" ?  "Belum Absen" : "Sudah Absen"}</p>
        </div>
          ...
          <div className="bg-sky-100 border-sky-700 p-4 md:p-6 shadow-xl rounded-md text-cyan-400 w-full max-w-xl">
            <div className="text-center">
              ...
              <div className="flex justify-center gap-3 flex-wrap">
                <button onClick={absenceSystem} className="bg-lime-600 px-4 py-2 rounded-xl text-green-200 cursor-pointer shadow-2xl">Mulai Absen</button>
                <button onClick={() => setOpen(false)} className="bg-red-600 px-4 py-2 rounded-xl text-red-200 cursor-pointer shadow-2xl">Kembali</button>
              </div>
            </div>
          </div>
        </div>
